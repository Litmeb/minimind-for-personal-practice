...
if __name__ == "__main__":
    ...
    parser.add_argument("--lora_name", type=str, default="lora_classifier", help="LoRA权重名称(如lora_identity/lora_medical等)")
    ...
    parser.add_argument("--data_path", type=str, default="../dataset/bbc_news_train.jsonl", help="LoRA训练数据路径")
